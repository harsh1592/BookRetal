 ...
 * 
 */
@WebServiceClient(name = "CalWS", targetNamespace = "http://CalculationWS/", wsdlLocation = "http://localhost:8080/CalculationWS/CalWS?WSDL")
    ...
    extends Service
{
    ...
    private final static QName CALWS_QNAME = new QName("http://CalculationWS/", "CalWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CalculationWS/CalWS?WSDL");
    ...
    public CalWS getCalWSPort() {
        return super.getPort(new QName("http://CalculationWS/", "CalWSPort"), CalWS.class);
    }
    ...
    public CalWS getCalWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://CalculationWS/", "CalWSPort"), CalWS.class, features);
    }
